    ...
    <div class="footer-grid">
      <div>
        <div class="brand" style="margin-bottom: 14px;">
          <img src="assets/img/favicon.svg" width="24" height="24" alt="OpenRTMP logo">
          OpenRTMP<span class="dot">.org</span>
        </div>
        <p style="max-width: 320px; margin: 0;">
          A pure protocol library for RTMP and E-RTMP. No media server logic,
          no HTTP, no auth policy &mdash; just the wire protocol, delivered
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="download.php">Download &amp; Build</a></li>
        </ul>
      </div>
      <div>
        <h4>Repositories</h4>
