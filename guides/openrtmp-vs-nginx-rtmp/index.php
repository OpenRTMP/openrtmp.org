      ...
      <article class="prose">
        ...
        <table class="comparison-table">
          ...
          <tbody>
            ...
            <tr><td>Project maturity</td><td>Active development (pre-1.0)</td><td>Long-established ecosystem</td></tr>
        ...
        <ul class="check-list">
          ...
          <li>You want optional multi-node HA with replicated stream state and can evaluate it carefully in your topology.</li>
          <li>You can test the exact publishing/playback workflow before critical production use.</li>
        </ul>
